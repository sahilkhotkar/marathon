        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="row mt-35">
              ...
              <div class="col-sm-6">
    <div class="form-group">
        <label for="tshirtsize">{{ __('T-Shirt Size') }} *</label>
        ...
        @enderror
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="address">{{ __('Emergency Contact') }} *</label>
                  <input type="text" name="econtact" id="phone" class="form-control"
                    value="{{ old('phone', $authUser != null ? $authUser->phone : '') }}"
                    placeholder="{{ __('Phone Number') }}">
                  @error('phone')
                    <p class="text-danger">{{ $message }}</p>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="econtactname" id="phone" class="form-control"
                    value="{{ old('phone', $authUser != null ? $authUser->phone : '') }}"
                    placeholder="{{ __('Phone Number') }}">
                  @error('phone')
                    <p class="text-danger">{{ $message }}</p>
